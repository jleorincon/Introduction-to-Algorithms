...
//Function to swap two integers without pass by reference since Java is pass-
//by-value only
...
//Function to compute the median of three numbers. Used to benchmark runtimes
//fo sorting algorithms.
...
//Check if the array is sorted. Used to check the correctness of the sorting
...
// Function to generate an array of size n filled with constants 
// (zero in this case)
...
// VERY IMPORTANT - THIS IS HOW YOU MANIPULATE THE CODE AND TEST OUT DIFFERENT SORTS
// Type of array to generate - Allowed values: 'r':Random, 's': Sorted, 'c':
//Constant
// Size of array to evaluate on - Allowed values: any positive integer > 0
// Sorting algorithm to evaluate - Allowed values: 'q': Quick Sort, 'i':
//Insertion Sort, 'm': Merge Sort, 's': Selection Sort
// Output: time taken to run sorting algorithm
   public static void main(String[] args) {
      ...
      if(!success) {
         ...
         System.out.println("Median Execution time: " + executionTime[medianof3(executionTime[0], executionTime[1], executionTime[2]) - 1] + " ns");
      }
